...
console.log("COURSE DATA BEFORE SEND:", courseData);
              ...
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                  ...
                  <div className="flex gap-2 my-4">
                    <p>Is Preview Free?</p>
                    <input type="checkbox" className='mt-1 scale-125' value={lectureDetails.isPreviewFree} onChange={(e) => setLectureDetails({...lectureDetails,isPreviewFree: e.target.value}) }/>
                  </div>
